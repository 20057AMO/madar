 ...
 *
 * Contract under test:
 *  - The canonical 28-action vocabulary, unknown/junk rejected.
...
describe('activity vocabulary — the 28 canonical actions', () => {
  test('covers the full saladin action list', () => {
    ...
    assert.strictEqual(ACTIVITY_ACTIONS.length, 28);
